...
TA<-cbind(TA2, lengthtracks, Vmean, v, tau, decordistance, D)
write.table(TA, "d:/Karen's/PhD/R program/Pheromone data/trackanalysis2.csv", 
...
## Summary
print(c(lengthtracks, Vmean, v, tau, decordistance, D))
